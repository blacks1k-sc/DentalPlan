...
var RepoReceiver = /** @class */ (function (_super) {
    ...
    RepoReceiver.prototype._createGitLabPipeline = function (projectName) {
        return __awaiter(this, void 0, void 0, function () {
            var createResult, _a, name, url, webhook, saved, pipeline, pipelinePermissionError, pipelineError;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        _a = JSON.parse(createResult), name = _a.name, url = _a.url, webhook = _a.webhook, saved = _a.saved, pipeline = _a.pipeline, pipelinePermissionError = _a.pipelinePermissionError;
                        pipelineError = pipelinePermissionError ? pipelinePermissionError : 'Jenkins pipeline not created.';
                        if (webhook === false)
                        ...
                        if (pipeline === false)
                            this.result.liveAlert(models_1.OutputColor.Red, 'Error', pipelineError);
    ...
    RepoReceiver.prototype._askForProjectName = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, helpers_1.default.createTextPrompt('Enter project name', 'Project name must be less than 61 characters long and be composed of only small letters, digits and these special characters: - and _', function (v) { return /^[a-z0-9_-]+$/.test(v); })];
                    case 1:
                        projectName = _a.sent();
