...
var WordpressReceiver = /** @class */ (function (_super) {
    ...
    function WordpressReceiver(context, requireAuth) {
        ...
        _this.context.registerNonArgFlags(['advanced', 'all', 'force', 'open', 'ftp', 'follow', 'help', 'override', 'dummy', 'cwd']);
    ...
    WordpressReceiver.prototype.init = function (starterCode) {
        return __awaiter(this, void 0, void 0, function () {
            var confirmed, options, choices, validStarterCodes, result, e_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
    ...
    WordpressReceiver.prototype.publish = function () {
        return __awaiter(this, void 0, void 0, function () {
            var err_1, pageVariant, wpData, strategy, remoteUrl, useGitlab;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 4]);
                    ...
                    case 2:
                        err_1 = _a.sent();
                        return [4 /*yield*/, this.showPricingLimitError(err_1.message || err_1)];
                    case 3:
                        _a.sent();
                        return [2 /*return*/];
                    case 4: return [4 /*yield*/, this._getPageVariant()];
                    case 5:
                        pageVariant = _a.sent();
                    ...
                    case 6:
                        ...
                        if (!(this.flags.ftp || this.context.mdbConfig.getValue('publishMethod') === 'ftp')) return [3 /*break*/, 7];
                        strategy = new publish_1.FtpPublishStrategy(this.context, this.result);
                        return [3 /*break*/, 10];
                    case 7:
                        if (!(this.context.mdbConfig.getValue('publishMethod') === 'pipeline')) return [3 /*break*/, 8];
                    ...
                    case 8:
                        ...
                        if (!(remoteUrl !== '')) return [3 /*break*/, 10];
                    ...
                    case 9:
                        ...
                        _a.label = 10;
                    case 10: return [4 /*yield*/, this._handlePublication(pageVariant, wpData, strategy)];
                    case 11:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    WordpressReceiver.prototype._handlePublication = function (pageVariant, wpData, strategy) {
        return __awaiter(this, void 0, void 0, function () {
            var projectName, email, username, withPipeline, hasDummy, dummy, response, firstPublication, payload, e_2, override, _a, domain;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        projectName = this.context.mdbConfig.getValue('projectName') || '';
                    ...
                    case 6:
                        e_2 = _b.sent();
                        if (!(e_2.statusCode === models_1.CliStatus.CONFLICT && e_2.message.includes('project name'))) return [3 /*break*/, 12];
                        return [4 /*yield*/, helpers_1.default.createConfirmationPrompt(e_2.message + " Override?", false)];
                    case 7:
                        override = _b.sent();
                        if (!override) return [3 /*break*/, 8];
                    ...
                    case 11:
                        ...
                        return [3 /*break*/, 16];
                    case 12:
                        if (!([models_1.CliStatus.CONFLICT, models_1.CliStatus.FORBIDDEN].includes(e_2.statusCode) && e_2.message.includes('domain name'))) return [3 /*break*/, 15];
    ...
    WordpressReceiver.prototype.delete = function (projectToDelete) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var projects, choices, projectName, _a, projectExists, name, _b, result, err_2;
    ...
    WordpressReceiver.prototype.get = function () {
        return __awaiter(this, void 0, void 0, function () {
            var projects, downloadToCurrentDir, choices, projectName, _a, project, result, repoUrlWithLogin, projectPath, query, e_4;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, this.getWordpressProjects()];
                    case 1:
    ...
    WordpressReceiver.prototype.kill = function () {
        return __awaiter(this, void 0, void 0, function () {
            var projects, projectsToPrompt, projectName, _a, projectExists, killType, result, err_3;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, this.getWordpressProjects()];
                    case 1:
    ...
    WordpressReceiver.prototype.info = function () {
        return __awaiter(this, void 0, void 0, function () {
            var projects, projectsToPrompt, projectName, _a, projectExists, result, _b, startedAt, killedAt, url, isUp, err_4;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0: return [4 /*yield*/, this.getWordpressProjects()];
                    case 1:
                    ...
                    case 6:
                        err_4 = _c.sent();
                        this.result.addAlert(models_1.OutputColor.Red, 'Error:', err_4.message);
                        return [3 /*break*/, 7];
                    case 7: return [2 /*return*/];
                }
            });
    ...
    WordpressReceiver.prototype.logs = function () {
        return __awaiter(this, void 0, void 0, function () {
            var projects, projectsToPrompt, projectName, _a, projectExists, _b, lines, tail, follow, followQuery, linesQuery, io_1, result, parsedResult, err_5;
            var _this = this;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0: return [4 /*yield*/, this.getWordpressProjects()];
                    ...
                    case 6:
                        err_5 = _c.sent();
                        this.result.addAlert(models_1.OutputColor.Red, 'Error', "Could not fetch logs for " + projectName + ": " + err_5.message);
                        return [3 /*break*/, 7];
                    case 7: return [2 /*return*/];
                }
            });
    ...
    WordpressReceiver.prototype.restart = function () {
        return __awaiter(this, void 0, void 0, function () {
            var projects, choices, projectName, _a, project, result, err_6;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, this.getWordpressProjects()];
                    case 1:
                    ...
                    case 6:
                        err_6 = _b.sent();
                        this.result.addAlert(models_1.OutputColor.Red, 'Error', "Could not restart project " + projectName + ": " + err_6.message);
                        return [3 /*break*/, 7];
                    case 7: return [2 /*return*/];
                }
            });
    ...
    WordpressReceiver.prototype.run = function () {
        return __awaiter(this, void 0, void 0, function () {
            var projects, choices, projectName, _a, project, technology, result, message, err_7;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, this.getWordpressProjects()];
                    case 1:
                    ...
                    case 6:
                        err_7 = _b.sent();
                        this.result.addAlert(models_1.OutputColor.Red, 'Error', "Could not run project " + projectName + ": " + err_7.message);
                        return [3 /*break*/, 7];
                    case 7: return [2 /*return*/];
                }
            });
    ...
    WordpressReceiver.prototype.getSocket = function () {
        return socket_io_client_1.io("https://" + config_1.default.host, { auth: { token: this.context.userToken }, timeout: 1000 });
    };
