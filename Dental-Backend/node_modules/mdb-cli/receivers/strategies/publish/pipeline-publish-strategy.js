...
exports.PipelinePublishStrategy = void 0;
...
var PipelinePublishStrategy = /** @class */ (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        _a.sent();
                        return [4 /*yield*/, this.git.pull(config_1.default.mdbgoPipelinePublicBranch, false).catch(function () { return null; })];
                    case 3:
                        _a.sent();
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        return [3 /*break*/, 4];
                    case 3:
                        this.result.addAlert(models_1.OutputColor.Green, 'Success', 'This time your project will be published using GitLab pipeline. We will remember to ask you again next time.');
                        _a.label = 4;
    ...
    PipelinePublishStrategy.prototype.updateProjectStatus = function () {
        ...
        var projectType = this.context.mdbConfig.getValue('meta.type');
...
exports.PipelinePublishStrategy = PipelinePublishStrategy;
