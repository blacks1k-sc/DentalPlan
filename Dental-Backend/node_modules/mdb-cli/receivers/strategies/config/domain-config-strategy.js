...
exports.DomainConfigStrategy = void 0;
...
var DomainConfigStrategy = /** @class */ (function (_super) {
    __extends(DomainConfigStrategy, _super);
    function DomainConfigStrategy(context, result) {
        ...
        _this.flags = context.getParsedFlags();
        return _this;
    }
    ...
    DomainConfigStrategy.prototype.unsetValue = function (name) {
        ...
        return this._unsetDomain()
            ...
            if (type === entity_1.default.Frontend) {
                ...
                _this.result.addAlert(models_1.OutputColor.Blue, 'Info', "Your project is now available at: " + url);
            }
            else if (type === entity_1.default.Backend || type === entity_1.default.Wordpress) {
                _this.context.mdbConfig.setValue('domain', url);
                _this.result.addAlert(models_1.OutputColor.Yellow, 'Warning', "Since this is a " + type + " project we had to reset your domain name to the default one. Your project is now available at: " + url);
            }
        })
            .then(function () { return _this.context.mdbConfig.save(); })
            .then(function () { return ''; });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.sent();
                        return [2 /*return*/, 'Certificate successfully enabled. Now you need to configure your DNS in order to finalize the configuration.'];
                }
            });
        });
    };
...
exports.DomainConfigStrategy = DomainConfigStrategy;
