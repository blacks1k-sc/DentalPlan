            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, helpers_1.default.createTextPrompt('Enter project name', 'Project name must be less than 61 characters long and be composed of only small letters, digits and these special characters: - and _', function (v) { return /^[a-z0-9_-]+$/.test(v); })];
                    case 1:
                        _b = (_c.sent());
                        _c.label = 2;
                    case 2:
