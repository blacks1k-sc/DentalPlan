...
var ConfigCommand = /** @class */ (function (_super) {
    ...
    ConfigCommand.prototype.setReceiver = function () {
        return __awaiter(this, void 0, void 0, function () {
            var _a;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _a = this.entity;
                        switch (_a) {
                            case entity_1.default.Config: return [3 /*break*/, 1];
                            case entity_1.default.Database: return [3 /*break*/, 4];
                        }
                        return [3 /*break*/, 5];
                    case 1:
                        if (!(this.args[0] !== 'init')) return [3 /*break*/, 3];
                        return [4 /*yield*/, this.requireDotMdb()];
                    case 2:
                        _b.sent();
                        _b.label = 3;
                    case 3:
                        this.receiver = new config_receiver_1.default(this.context);
                        return [3 /*break*/, 5];
                    case 4:
