...
var DeleteCommand = /** @class */ (function (_super) {
    ...
    function DeleteCommand(context) {
        ...
        _this.receiver = _this.getReceiver();
        return _this;
    }
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        if (!(this.receiver.flags.all || this.receiver.flags.many || this.context.args.length > 0)) return [3 /*break*/, 2];
                        return [4 /*yield*/, this.receiver.deleteMany()];
                    case 1:
                        _a.sent();
                        return [3 /*break*/, 4];
                    case 2: return [4 /*yield*/, this.receiver.delete()];
                    case 3:
                        _a.sent();
                        _a.label = 4;
                    case 4:
    ...
    DeleteCommand.prototype.getReceiver = function () {
        switch (this.entity) {
            case entity_1.default.Backend: return new backend_receiver_1.default(this.context);
            case entity_1.default.Frontend: return new frontend_receiver_1.default(this.context);
            case entity_1.default.Database: return new database_receiver_1.default(this.context);
            case entity_1.default.Wordpress: return new wordpress_receiver_1.default(this.context);
            default: return new frontend_receiver_1.default(this.context);
        }
    };
