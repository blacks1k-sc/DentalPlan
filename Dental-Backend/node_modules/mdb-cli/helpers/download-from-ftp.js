...
var unzip_stream_1 = __importDefault(require("unzip-stream"));
function downloadFromFTP(http, options, destination) {
    return new Promise(function (resolve, reject) {
        var request = http.createRawRequest(options, function (response) {
            ...
            try {
                readStream.pipe(unzip_stream_1.default.Extract({ path: destination })).on('close', function () { return resolve(result); });
            }
            catch (e) {
